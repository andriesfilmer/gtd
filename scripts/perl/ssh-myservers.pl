...
#
# Install gnome-gpg (to remember te passphrase for your session)
...
#
$username = $ENV{USER};
$encryptedPassFile = '${username}.gpg';
...
#
$gpg_line = `/usr/bin/gnome-gpg --decrypt /home/$username/.gnupg/$encryptedPassFile | grep -i '^$server_str'`;
